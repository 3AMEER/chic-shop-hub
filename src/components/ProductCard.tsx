      ...
      <div className="relative overflow-hidden rounded-2xl bg-card shadow-soft transition-smooth hover:shadow-elegant">
        <div className="relative aspect-square overflow-hidden bg-muted">
          ...
          <button
            ...
            className="absolute start-3 top-3 flex h-10 w-10 items-center justify-center rounded-full bg-background/90 backdrop-blur-sm shadow-soft transition-smooth hover:scale-110"
          >
            <Heart
              className={cn(
          ...
          <button
            ...
            className="absolute inset-x-3 bottom-3 hidden translate-y-16 items-center justify-center gap-2 rounded-xl bg-primary px-4 py-3 text-sm font-medium text-primary-foreground opacity-0 shadow-elegant transition-smooth group-hover:translate-y-0 group-hover:opacity-100 hover:bg-primary/90 sm:flex"
          >
