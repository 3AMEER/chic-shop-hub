...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover elegant accessories, makeup, and bags. Order seamlessly via WhatsApp." },
      { property: "og:title", content: "Maison — Curated Luxury Boutique" },
      { property: "og:description", content: "Discover elegant accessories, makeup, and bags." },
